	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
            ...
            <div style="float: left;">
                <button class="btn btn-inverse btn_iserl tooltips" title="คลิกปุ่มเพื่อย้อนกลับ" onclick="window.location='<?php echo site_url('/'.$dir.'/Field_manage');?>'"><span>ยกเลิก</span></button>
            </div>	  
