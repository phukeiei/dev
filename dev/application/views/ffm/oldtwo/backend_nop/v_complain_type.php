...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading panel_table_iserl">
             <h2><i class="fas fa-cogs"></i></i>จัดการประเภทความคิดเห็น</h2>
            ...
            <table class="table table-striped table-bordered table_iserl no-footer table-hover dataTable-Export" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left"><?php echo $row->tp_complain;?></td>
                        <td class="text-center" width="20%">
                            <button class="btn btn-orange btn_check_iserl tooltips ti ti-pencil" title="คลิกปุ่มเพื่อแก้ไขข้อมูล" data-toggle="modal" href="#myModal2" onclick="get_name_type_by_id(<?php  echo $row->tp_id;?>) "></button>
                            
                            <a href="<?php echo site_url('/'.$dir.'/Type_complain/delete_complain_type/'.$row->tp_id);?>" class="btn btn-danger btn_check_iserl tooltips ti ti-close" title="คลิกปุ่มเพื่อลบข้อมูล" ></a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
       ...
       <!-- frz ADD -->     <form method="POST" onsubmit="return validate()" action="<?php echo site_url($dir.'/Type_complain/insert_complain_type'); ?>" > 
