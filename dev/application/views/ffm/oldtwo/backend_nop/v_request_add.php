	...
	<div class="panel panel-default">
        ...
        <div class="panel-footer">
            <div style="float: left;">
                 <button class="btn btn-danger btn_iserl tooltips" title="คลิกปุ่มเพื่อยกเลิกข้อมูล" onclick="window.location='<?php echo site_url('/'.$dir.'/Field_reservation/v_request_list');?>'" ><span>ยกเลิก</span></button>
            </div>
