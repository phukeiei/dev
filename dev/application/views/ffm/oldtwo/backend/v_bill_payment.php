...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <button class="btn btn-social btn-google btn_iserl tooltips ti ti-plus " data-toggle="modal"  href="#myModal" ><span></span></button>
               </div>
...
<script> 
    ...
    function insert_cost($field_id){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url("/ffm/Ffm_Controller/calculate_cost");?>',
            data:{
            ...
            success : function(data){
                ...
                array.forEach((row, index) => {
                    ...
                    if (time_start.isBetween(beforeTime, afterTime) ||  time_end.isBetween(beforeTime, afterTime) || time_start.isSame(beforeTime) ||  time_start.isSame(afterTime) || time_end.isSame(beforeTime) ||  time_end.isSame(afterTime)) {
                        check = false
                    } 
