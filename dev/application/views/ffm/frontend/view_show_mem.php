                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="radio" class="form-check-input" id="time1" name="time1"
                                                    aria-required="true" checked>กำหนดเอง<br>
                                                ...
                                                <input type="radio" class="form-check-input" id="time2" name="time2"
                                                    aria-required="true">ช่วงเช้า (09:00 - 12:00)<br>
                                                
                                                <input type="radio" class="form-check-input" id="time3" name="time3"
                                                    aria-required="true">ช่วงเย็น (13:00 - 16:00)<br>
                                                
                                                <input type="radio" class="form-check-input" id="time4" name="time4"
                                                    aria-required="true">ทั้งวัน (09:00 - 21:00)<br>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="ml-auto">
                                <input type="button" class="btn btn-next btn-fill btn-primary btn-wd" name="next"
                                    value="Next">
                                <input type="button" class="btn btn-finish btn-fill btn-success btn-wd" name="finish"
