...
<script>
    $(document).ready(function() {
		callselect()
		$('#Reg_me').on('keyup keypress', function(e) {
        ...
        $("input").on("keyup",function(){
			$("input").each(function(){
				//console.log("[name='"+$(this).attr("name")+"_show']")
				$("[name='"+$(this).attr("name")+"_show']").val($(this).val())
			})
		})
		$("#date1").on("dp.change",function(){Cal_money()})
		$("#date2").on("dp.change",function(){Cal_money()})
        $("select").on("change",function(){
            Cal_money()
			$("select").each(function(){
				//console.log("[name='"+$(this).attr("name")+"_show']")
				$("[name='"+$(this).attr("name")+"_show']").val($("select[name='"+$(this).attr("name")+"'] option[value='"+$(this).val()+"']").html())
			})
		})
	...
	function Cal_money(){
		$.post("http://10.80.39.251/ossd/index.php/ffm/frontend/C_test/get_by_id",
		  {
			ff_id: $("#ff_select").val()
		  },
		function(data){
			var Data = JSON.parse(data)
			$('[name="total"]').attr("max",Data[0].ff_size)
			$('[id="max_show"]').text("0-"+Data[0].ff_size) 
		})
		$.post({url:"<?php echo site_url() ?>/ffm/Ffm_Controller/calculate_cost",
		data:{start_time:$("[name='time_start']").val(),
		end_time:$("[name='time_end']").val(),
		field:$("#ff_select").val(),
		type:"1",
		return_type:"1"},
		success:function(data){
			var Data = JSON.parse(data)
			//console.log(Data);
			var date1 = $("[name='date1']").val().split("/")
			var date2 = $("[name='date2']").val().split("/")
    ...
    $(document).ready(function() {
        ...
        $("#time2,#time3,#time4").on("click", function() {
			...
			if($(this).attr("id") == "time2"){
				$('[name="time_start"]').val("09:00:00")
				$('[name="time_end"]').val("12:00:00")
				Cal_money()
			}
			if($(this).attr("id") == "time3"){
				$('[name="time_start"]').val("13:00:00")
				$('[name="time_end"]').val("16:00:00")
				Cal_money()
			}
			if($(this).attr("id") == "time4"){
				$('[name="time_start"]').val("09:00:00")
				$('[name="time_end"]').val("21:00:00")
				Cal_money()
			}
        });
		$("#time1-1").change(function(){
			$('[name="time_start"]').val($(this).val()+":00")
			Cal_money()
		})
		$("#time1-2").change(function(){
			$('[name="time_end"]').val($(this).val()+":00")
			Cal_money()
		})
        $('.btn-next ,.nav-link').on("click", function(e) {
				...
				if($(".tab-pane.active").index() == 2){
					$.ajax({
					   ...
					   success: function(data)
					   {
						   // $("#iframe_detail").attr("src","<?php echo site_url('/ffm/frontend/C_downloadpdf/export_pdf_With_Data/');?>/"+data)
						   // $("#Show_detail").attr("href","<?php echo site_url('/ffm/frontend/C_downloadpdf/export_pdf_With_Data/');?>/"+data)
					   }
					 });
				}
    ...
    <div class="col-md-10">
        <div class="wizard-container">
            <div class="card card-wizard active" data-color="primary" id="wizardProfile">
                <form id="Reg_me" action="<?php echo site_url('/ffm/frontend/C_test/insert_reservation_form');?>" method="POST">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="selectpicker" data-style="select-with-transition" name="quantity" id="dropdownList" data-size="7" tabindex="-98">
                                                    <?php foreach($qu_mr as $row){?>
                                                        <option name="prefix" value="<?php echo $row->pf_id;?>"><?php echo $row->pf_name;?></option>
                                                        <?php }?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="zipcode" name="zipcode" aria-required="true">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="form-group bmd-form-group is-focused">
                                                    ...
                                                    <input type="text" class="form-control autocomplete required_check" id="dist_name" name="dist_name" aria-required="true" get="get_address">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="amph_name" name="amph_name" aria-required="true" readonly>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="pv_name" name="pv_name" aria-required="true" readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInput1" name="project" aria-required="true">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <br>
                                                <input id="time1-1" class="clockpicker form-control" value="09:00" data-default="09:00">
                                                <input id="time1-2" class="clockpicker form-control" value="21:00" data-default="21:00">
                                                ...
                                                <br>
                                                <input type="hidden" name="time_start" class="clockpicker form-control" value="09:00:00">
                                                <input type="hidden" name="time_end" class="clockpicker form-control" value="21:00:00">
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="exampleInput1" name="price" aria-required="true" value="0" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="input-group-prepend">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group bmd-form-group">
                                                    <label for="exampleInput1" class="bmd-label-floating" id="max_show">0-100
                                                    </label>
                                                    <input type="number" class="form-control required_check" id="exampleInput1" name="total" aria-required="true" value="0" min="0" max="100">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="input-group-prepend">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="exampleInput1" name="quantity_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- ชื่อ-นามสกุล -->
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="exampleInput1" name="fname_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="exampleInput1" name="lname_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- เบอร์โทร -->
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="exampleInput1" name="phone_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="exampleInput1" name="adress_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="exampleInput1" name="moo_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="zipcode" name="zipcode_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="form-group is-focused bmd-form-group is-focused">
                                                    <label for="exampleInput1" class="bmd-label-floating">ตำบล
                                                    </label>
                                                    <input type="text" class="form-control " id="dist_name" name="dist_name_show" aria-required="true" get="get_address" readonly>
                                                    <input type="hidden" id="dist_id" name="dist_id_show">
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="amph_name" name="amph_name_show" aria-required="true" readonly>
                                                    <input type="hidden" id="amph_id" name="amph_id_show">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="pv_name" name="pv_name_show"aria-required="true" readonly>
                                                    <input type="hidden" id="pv_id" name="pv_id_show">
...
<h5> ข้อมูลการจองสนาม </h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="text" class="form-control " id="exampleInput1" name="project_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                        </div>
										<div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group is-focused bmd-form-group">
                                                    <label for="exampleInput1" class="bmd-label-floating">สนาม
                                                    </label>
                                                    <input type="text" class="form-control " id="exampleInput1" name="field_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group is-filled">
                                                    <input type="text" class="form-control datepicker-thai" id="date1" name="date1_show" value="<?php echo getNowDateFwTh();?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group is-filled">
                                                    <input type="text" class="form-control datepicker-thai" id="date2" name="date2_show" value="<?php echo getNowDateFwTh();?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group is-filled">
                                                    <input type="text" class="form-control" id="time_start" name="time_start_show" value="09:00" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group is-focused bmd-form-group is-filled">
                                                    <input type="text" class="form-control" id="time_start" name="time_end_show" value="21:00" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="exampleInput1" name="price_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="input-group-prepend">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group is-focused bmd-form-group">
                                                    ...
                                                    <input type="number" class="form-control " id="exampleInput1" name="total_show" aria-required="true" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="input-group-prepend">
                            ...
                            <div class="tab-pane" id="download">
                                <div class="row justify-content-center">
                                    <div class="col-sm-12">
                                        <iframe id="iframe_detail" src="<?php //echo site_url('/ffm/frontend/C_downloadpdf/export_pdf_With_Data/1'); ?>" style="width: 100%;height: 980px;"></iframe>

                                        <a target="_blank"id="Show_detail" type="button" rel="tooltip"
                                            class="btn btn-danger  btn-wd"
                                            href="<?php //echo site_url('/ffm/frontend/C_downloadpdf/export_pdf_With_Data/1');?>"style=" margin-left: 45%; ">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="ml-auto">
                                ...
                                <a href="<?php if(null !==$this->session->userdata("UsID")){echo site_url('/ffm/frontend/C_list_reservation/Export_list_reservation');}else{echo site_url('/ffm/frontend/C_test/show2');}?>" class="btn btn-finish btn-fill btn-success btn-wd" name="finish" value="Finish" style="display: none;">Finish</a>
                            </div>
