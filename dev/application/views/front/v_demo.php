            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12 social-buttons-demo">
                    ...
                    <button class="btn btn-social btn-fill btn-youtube">
                        <i class="fab fa-youtube-play"></i> View on Youtube
                    </button>
                    <br>
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-3">
                            <div class="dropdown">
                                <button class="dropdown-toggle btn btn-primary btn-round btn-block" type="button"
                                        id="multiDropdownMenu" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    Multilevel Dropdown
                                </button>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group label-floating">
                        <label class="form-control-label bmd-label-floating" for="exampleInputTextarea"> You can write
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" value="Amsterdam,Washington,Sydney,Beijing" class="tagsinput form-control"
...
<div class="section section-navbars cd-section" id="navigation">
    ...
    <div id="navbar">
        <div class="navigation-example"
             style="background-image: url('<?php echo base_url(); ?>frontend/assets/img//bg.jpg');">
                            ...
                            <li class="dropdown nav-item">
                                <a href="#pablo" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="profile-photo-small">
                                        <img src="<?php echo base_url(); ?>frontend/assets/img/faces/avatar.jpg"
                                             alt="Circle Image"
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="example-navbar-transparent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="#pablo" class="nav-link">
                                    <i class="far fa-instagram"></i> Instagram
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="tab-content text-center">
                                <div class="tab-pane active" id="profile">
                                    <p> I will be the leader of a company that ends up being worth billions of dollars,
                                        ...
                                        a responsibility that I have, to push possibilities, to show people, this is the
                                        level that things could be at. I think that&#x2019;s a responsibility that I
                                ...
                                <div class="tab-pane" id="messages">
                                    <p> I think that&#x2019;s a responsibility that I have, to push possibilities, to
                                        show people, this is the level that things could be at. I will be the leader of
                                        a company that ends up being worth billions of dollars, because I got the
                                ...
                                <div class="tab-pane" id="settings">
                                    <p>I think that&#x2019;s a responsibility that I have, to push possibilities, to
                                        ...
                                        the furthest possibilities. I will be the leader of a company that ends up being
                                        worth billions of dollars, because I got the answers. I understand culture. I am
                                        the nucleus.</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container tim-container">
        ...
        <div id="images">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <h4>Rounded Image</h4>
                    <img src="<?php echo base_url(); ?>frontend/assets/img/faces/avatar.jpg" alt="Rounded Image"
                         class="rounded img-fluid">
                </div>
                <div class="col-sm-2 ml-auto">
                    <h4>Circle Image</h4>
                    <img src="<?php echo base_url(); ?>frontend/assets/img/faces/avatar.jpg" alt="Circle Image"
                         class="rounded-circle img-fluid">
                </div>
                <div class="col-sm-2 ml-auto">
                    <h4>Rounded Raised</h4>
                    <img src="<?php echo base_url(); ?>frontend/assets/img/faces/avatar.jpg" alt="Raised Image"
                         class="img-raised rounded img-fluid">
                </div>
                <div class="col-sm-2 ml-auto">
                    <h4>Circle Raised</h4>
                    <img src="<?php echo base_url(); ?>frontend/assets/img/faces/avatar.jpg" alt="Thumbnail Image"
                        ...
                        <div class="table-responsive">
                            <table class="table table-shopping">
                                ...
                                <tr>
                                    <td>
                                        <div class="img-container">
                                            <img src="<?php echo base_url(); ?>frontend/assets/img/product1.jpg"
                                                 alt="...">
                                        </div>
                                    </td>
                                    <td class="td-name">
                                    ...
                                    <td class="td-number">
                                        1
                                        <div class="btn-group">
                                            <button class="btn btn-round btn-info btn-sm"><i class="material-icons">remove</i>
                                            </button>
                                            <button class="btn btn-round btn-info btn-sm"><i
                                ...
                                <tr>
                                    <td>
                                        <div class="img-container">
                                            <img src="<?php echo base_url(); ?>frontend/assets/img/product2.jpg"
                                                 alt="...">
                                        </div>
                                    </td>
                                    <td class="td-name">
                                ...
                                <tr>
                                    <td>
                                        <div class="img-container">
                                            <img src="<?php echo base_url(); ?>frontend/assets/img/product3.jpg"
                                                 alt="...">
                                        </div>
                                    </td>
                                    <td class="td-name">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img"
                                         src="<?php echo base_url(); ?>frontend/assets/img/examples/card-blog1.jpg">
                        ...
                        <div class="card bg-info">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">
                                    <a href="#pablo">&quot;You Don&apos;t Have to Sacrifice Joy to Build a Fabulous
                                        Business and Life&quot;</a>
                                </h4>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-footer ">
                                <div class="author">
                                    <a href="#pablo">
                                        <img src="<?php echo base_url(); ?>frontend/assets/img/faces/christian.jpg"
                                             alt="..." class="avatar img-raised">
                                        <span>Lord Alex</span>
                                    </a>
                                </div>
                        ...
                        <div class="card card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img"
                                         src="<?php echo base_url(); ?>frontend/assets/img/examples/card-blog2.jpg">
                                </a>
                            </div>
                            <div class="card-body ">
                            ...
                            <div class="card-footer ">
                                <div class="author">
                                    <a href="#pablo">
                                        <img src="<?php echo base_url(); ?>frontend/assets/img/faces/marc.jpg" alt="..."
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6">
                                <div class="card card-blog">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img"
                                                 src="<?php echo base_url(); ?>frontend/assets/img/examples/blog8.jpg">
                                        </a>
                                    </div>
                                    <div class="card-body ">
                                        <h6 class="card-category text-danger">
                                    ...
                                    <div class="card-footer ">
                                        <div class="author">
                                            <a href="#pablo">
                                                <img src="<?php echo base_url(); ?>frontend/assets/img/faces/marc.jpg"
                                                     alt="..."
                                                     class="avatar img-raised">
                                                <span>Mike John</span>
                                            </a>
                            ...
                            <div class="col-lg-12 col-md-6">
                                <div class="card bg-success">
                                    <div class="card-body ">
                                        <h5 class="card-category card-category-social">
                                            <i class="far fa-newspaper-o"></i> TechCrunch
                                        </h5>
                                        <h4 class="card-title">
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img"
                                         src="<?php echo base_url(); ?>frontend/assets/img/examples/card-profile4.jpg">
                                    <div class="card-title">
                                        Tania Andrew
                                    </div>
                                </a>
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img"
                                         src="<?php echo base_url(); ?>frontend/assets/img/examples/card-profile1.jpg">
                                </a>
                            </div>
                            <div class="card-body ">
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img" src="<?php echo base_url(); ?>frontend/assets/img/faces/marc.jpg">
                                </a>
                            </div>
                            <div class="card-body ">
                                <h6 class="card-category text-gray">CEO / Co-Founder</h6>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-background"
                             style="background-image: url('<?php echo base_url(); ?>frontend/assets/img/examples/office1.jpg')">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card card-background"
                             style="background-image: url('<?php echo base_url(); ?>frontend/assets/img/examples/card-blog3.jpg')">
                            <div class="card-body">
                        ...
                        <div class="rotating-card-container">
                            <div class="card card-rotate card-background">
                                <div class="front front-background"
                                     style="background-image: url('<?php echo base_url(); ?>frontend/assets/img/examples/card-blog5.jpg');">
                                    <div class="card-body">
                            ...
                            <div class="card card-rotate bg-rose">
                                <div class="front">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">
                                            <a href="#pablo">"Dribbble just acquired Crew, a very interesting
                                                startup..."</a>
                                        </h4>
                                        <p class="card-description">
                                            Don't be scared of the truth because we need to restart the human foundation
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="stats">
                                            <button type="button" name="button"
                                                    class="btn btn-white btn-fill btn-round">
                                                <i class="material-icons">subject</i> Read
                                            </button>
                                            <button type="button" name="button"
                                                    class="btn btn-white btn-round btn-link">
                ...
                <div class="row">
                        ...
                        <div class="rotating-card-container manual-flip">
                            <div class="card card-rotate">
                                <div class="front">
                                    <div class="card-body">
                                        <h5 class="card-category card-category-social text-success">
                                            <i class="far fa-newspaper-o"></i> Manual Rotating Card
                                        </h5>
                                        <h4 class="card-title">
                                            <a href="#pablo">"This card is doing a full rotation, click on the rotate
                                                button"</a>
                                        </h4>
                                        <p class="card-description">
                                            Don't be scared of the truth because we need to restart the human foundation
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="rotating-card-container manual-flip">
                            <div class="card card-rotate">
                                <div class="front front-background"
                                     style="background-image: url('<?php echo base_url(); ?>frontend/assets/img/examples/card-blog6.jpg');">
                                    <div class="card-body">
                                        <h6 class="card-category">Full Background Card</h6>
                                        <a href="#pablo">
                                            <h3 class="card-title">This card is doing a full rotation, click on the
                                                rotate button</h3>
                                        </a>
                                        <p class="card-description">
                                            Don't be scared of the truth because we need to restart the human...
                            ...
                            <div class="card card-rotate bg-warning">
                                <div class="front">
                                    <div class="card-body">
                                        ...
                                        <div class="stats text-center">
                                            <button type="button" name="button"
                                                    class="btn btn-white btn-fill btn-round btn-rotate">
                                                <i class="material-icons">refresh</i> Rotate...
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="back">
                                    <div class="card-body">
                                        ...
                                        <div class="stats text-center">
                                            ...
                                            <br>
                                            <button type="button" name="button"
                                                    class="btn btn-white btn-round btn-rotate">
                                                <i class="material-icons">refresh</i> Back...
                                            </button>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="title">
                        ...
                        <h4>Material Kit PRO is coming with the famous colored shadows. That means each image from the
                            cards is getting an unique color shadow. You don&apos;t have to do anything to activate
                            them, just enjoy the new look of your website.</h4>
                        <br>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="card card-blog">
                        <div class="card-header card-header-image">
                            <a href="#pablo">
                                <img src="<?php echo base_url(); ?>frontend/assets/img/examples/color1.jpg" alt="">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card card-blog">
                        <div class="card-header card-header-image">
                            <a href="#pablo">
                                <img src="<?php echo base_url(); ?>frontend/assets/img/examples/color2.jpg" alt="">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card card-blog">
                        <div class="card-header card-header-image">
                            <a href="#pablo">
                                <img src="<?php echo base_url(); ?>frontend/assets/img/examples/color3.jpg" alt="">
                            </a>
                        </div>
                        <div class="card-body ">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-blog card-plain">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img src="<?php echo base_url(); ?>frontend/assets/img/examples/blog5.jpg" alt="">
                                    <div class="card-title">
                                        This Summer Will be Awesome
                                    </div>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-blog card-plain">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img"
                                         src="<?php echo base_url(); ?>frontend/assets/img/examples/blog1.jpg">
                                </a>
                            </div>
                            <div class="card-body ">
                                <h6 class="card-category text-success">Legal</h6>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6">
                                <div class="card card-blog card-plain">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img"
                                                 src="<?php echo base_url(); ?>frontend/assets/img/examples/blog6.jpg">
                                        </a>
                                    </div>
                                    <div class="card-body ">
                                        <h6 class="card-category text-danger">
                            ...
                            <div class="col-lg-12 col-md-6">
                                <div class="card bg-danger">
                                    <div class="card-body">
                                        <h5 class="card-category card-category-social">
                                            <i class="far fa-newspaper-o"></i> The Next Web
                                        </h5>
                                        <h4 class="card-title">
                                            <a href="#pablo">&quot;Focus on Your Employees&quot;</a>
                                        </h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker-thai" value="10/10/2016">
                            </div>
                            <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-5 col-sm-8">
                    ...
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        <div class="fileinput-new thumbnail img-raised">
                            <img src="<?php echo base_url(); ?>frontend/assets/img/image_placeholder.jpg" alt="...">
                        </div>
                ...
                <div class="col-md-3 col-sm-4">
                    ...
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        <div class="fileinput-new thumbnail img-circle img-raised">
                            <img src="<?php echo base_url(); ?>frontend/assets/img/placeholder.jpg" alt="...">
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group form-file-upload form-file-multiple">
                        <input type="file" multiple="" class="inputFileHidden">
                        <div class="input-group">
                            <input type="text" class="form-control inputFileVisible" placeholder="Multiple Files"
                                   multiple>
                            <span class="input-group-btn">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<?php echo base_url(); ?>frontend/assets/img/bg2.jpg"
                                     alt="First slide">
                            ...
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo base_url(); ?>frontend/assets/img/bg3.jpg"
                                     alt="Second slide">
                                <div class="carousel-caption d-none d-md-block">
                                    <h4>
                            ...
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo base_url(); ?>frontend/assets/img/bg.jpg"
                                     alt="Third slide">
                                <div class="carousel-caption d-none d-md-block">
                                    <h4>
                                        <i class="material-icons">location_on</i> Yellowstone National Park, United
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p>The first step is to create an account at
                                <a href="http://www.creative-tim.com/">Creative Tim</a>. You can choose a social network
                                or go for the classic version, whatever works best for you.</p>
                        </div>
                        <div class="col-md-4">
                            <div class="picture">
                                <img src="<?php echo base_url(); ?>frontend/assets/img/dg1.jpg" alt="Thumbnail Image"
                                     class="rounded img-fluid">
                            </div>
                        </div>
                    </div>
                ...
                <div class="instruction">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="picture">
                                <img src="<?php echo base_url(); ?>frontend/assets/img/dg2.jpg" alt="Thumbnail Image"
                                     class="rounded img-fluid">
                            </div>
                        </div>
                    </div>
