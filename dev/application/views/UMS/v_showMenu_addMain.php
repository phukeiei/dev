			...
			<form class="form-horizontal row-border" id="validate-form" data-parsley-validate method="post" action="<?php echo base_url(); ?>index.php/UMS/showSystem/addMenu1">	
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">ชื่อเมนู(ท)</label>
						<div class="col-sm-4">
				...
				<div class="panel-footer">
					<div class="col-sm-12 col-sm-offset-0">
						<div class="btn-toolbar">
							...
							<a class="btn-danger btn pull-right" onclick="window.location.href='<?php  echo base_url(); ?>index.php/UMS/showSystem/showMenu/<?php echo $MnStID ?>'" value="ยกเลิก" name="cancle">ยกเลิก</a>
