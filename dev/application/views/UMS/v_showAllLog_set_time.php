			...
			<form class="form-horizontal row-border" id="validate-form" data-parsley-validate method="post" action="<?php echo base_url(); ?>index.php/UMS/showLog/setTime">	
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="UsLogin" id="UsLogin" value="<?php echo $UsLogin;?>">
						</div>
						<label class="col-sm-1 control-label">ชื่อ - นามสกุล</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="UsName" id="UsName" value="<?php echo $UsName;?>" >
						</div>
					</div>
					<div class="form-group">
