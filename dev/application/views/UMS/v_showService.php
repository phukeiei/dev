                	...
                	<div id="da-content-area">
						<div class="grid_3_center">
                        	<div id="manage" class="da-panel collapsible collapsed">
								...
								<form id="validate-Service" class="da-form" method="post" action="<?php echo base_url(); ?>index.php/UMS/showService/add">
...
delay: 250
											...
											<div class="da-form-row">
												<div class="da-form-col-6-10">
													...
													<div class="da-form-item large">
														<input type="text" name="SvNameT" placeholder="ชื่อบริการภาษาไทย"/>
														<img src="<?php echo base_url(); ?>/images/icons/Help.png" style="width:20px;height:20px;"alt=""  title="กรอกชื่อบริการภาษาไทย" />
													</div>
												</div>		
											</div>		
											...
											<div class="da-form-row">
												<div class="da-form-col-6-10">
													...
													<div class="da-form-item large">
														<input type="text" name="SvNameE" placeholder="ชื่อบริการภาษาอังกฤษ"/>
											...
											<div class="da-form-row">
												<div class="da-form-col-6-10">
													...
													<div class="da-form-item large">
														<input type="text" name="SvURL" placeholder="URL"/>
														<img src="<?php echo base_url(); ?>/images/icons/Help.png" style="width:20px;height:20px;"alt=""  title="กรอก  URL" />
													</div>
												</div>		
											</div>		
											<div class="da-form-row">
												<div class="da-form-col-6-10">
													...
													<div class="da-form-item large">
														<input type="text" name="SvIcon" id="da-ex-dialog-modal" placeholder="ไอคอนบริการ"/>
