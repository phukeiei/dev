			...
			<form id="validate-WGSer" class="da-form" method="post"action ="<?php echo base_url(); ?>/index.php/UMS/department/add">
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="ชื่อหน่วยงาน" required name="dpName" class="form-control tooltips" data-trigger="hover" data-original-title="กรุณากรอกชื่อหน่วยงาน"/>
						</div>
					</div><br>
					<div class="form-group">
