<head>
    ...
    <title>ใบสมัครสมาชิกศูนย์นันทนาการเพื่อประชาชนเทศบาลตำบลบางปลา</title>
</head>
<style>
<!--- border --->
p.round1{
...
<body> 
		<table width="100%" border="0">
			<tr>
				<td width="25%" align="center" ><img src ="<?php echo base_url();?>/application/views/swm/frontend/IMG/LogoBW.png" class="rounded img-fluid" width = "150px"></td>
				<td width="50%" align="center">ใบสมัครสมาชิกศูนย์นันทนาการเพื่อประชาชน<br>เทศบาลตำบลบางปลา</td></td>
		...
		<table width="100%" border="0">
			<tr>
				<td>
					<p style="text-align:justify"><?php echo"&emsp;&emsp;"?>มีความประสงค์จะสมัครสมาชิก เพื่อเข้าใช้บริการศูนย์นันทนาการเพื่อประชาชน เทศบาลตำบลบางปลา</p>
						<p style="text-align:justify">นันทนาการเพื่อประชาชน เทศบาลตำบลบางปลา 
ของเทศบาลฯ เป็นที่เข้าใจดีเเล้ว ทั้งนี้ในการใช้สนามกีฬาต่างๆ ให้อยู่ในความรับผิดชอบของข้าพเจ้าเอง<br>เเละจะไม่ก่อให้เกิดความผูกพันธ์หรือความรับผิดชอบเเก่เทศบาลตำบลบางปลาในทางกฏหมายไม่ว่าในกรณีใดๆ และข้าพเจ้าจะไม่เรียกร้องสิทธิ์ใดๆทั้งสิ้น</p>
