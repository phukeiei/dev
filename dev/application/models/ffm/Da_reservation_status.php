...
class Da_reservation_status extends Ffm_model {
	...
	function insert() {
		...
		$sql = "INSERT INTO reservation_status (rs_id, rs_name, rs_active, rs_update, rs_user_update)
				VALUES(?, ?, ?, ?, ?)";
		$this->db->query($sql, array($this->rs_id, $this->rs_name, $this->rs_active, $this->rs_update, $this->rs_user_update));
	...
	function update() {
		...
		$sql = "UPDATE reservation_status 
				...
				WHERE rs_id=?";	
		$this->db->query($sql, array($this->rs_name, $this->rs_active, $this->rs_update, $this->rs_user_update, $this->rs_id));	
	}
	...
	function delete() {
		...
		$sql = "DELETE FROM reservation_status
				WHERE rs_id=?";
		$this->db->query($sql, array($this->rs_id));
	}
	...
	function get_by_key($withSetAttributeValue=FALSE) {	
		$sql = "SELECT * 
				...
				WHERE rs_id=?";
		$query = $this->db->query($sql, array($this->rs_id));
