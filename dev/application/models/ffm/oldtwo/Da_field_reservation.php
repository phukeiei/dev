...
include_once("application/models/ffm/ffm_model.php");
...
class Da_field_reservation extends Ffm_model {
	...
	function insert() {
		...
		$sql = "INSERT INTO ".$this->ffm_db.".field_reservation (fr_id, fr_ff_id, fr_start_time, fr_end_time, fr_ps_id, pf_id,fr_first_name, fr_last_name, fr_address, fr_moo, fr_dist_id, fr_amph_id, fr_pv_id, fr_tel, fr_project, fr_start_date, fr_end_date, fr_hour, fr_minute, fr_cost, fr_status, fr_write_date, fr_number, fr_fr_id, fr_update, fr_user_update)
				VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		$this->ffm->query($sql, array($this->fr_id, $this->fr_ff_id, $this->fr_start_time, $this->fr_end_time, $this->fr_ps_id, $this->pf_id,$this->fr_first_name, $this->fr_last_name, $this->fr_address, $this->fr_moo, $this->fr_dist_id, $this->fr_amph_id, $this->fr_pv_id, $this->fr_tel, $this->fr_project, $this->fr_start_date, $this->fr_end_date, $this->fr_hour, $this->fr_minute, $this->fr_cost, $this->fr_status, $this->fr_write_date, $this->fr_number, $this->fr_fr_id, $this->fr_update, $this->fr_user_update));
