...
class C_downloadpdf extends  Ffm_Controller{
    ...
    function export_pdf(){
        ...
        <div style = "font-family:th sarabun psk">
            ...
            <div>
                <dd><dd>ในวันที่ '.$this->StringToDot('21',10).' เดือน '.$this->StringToDot('พฤษภาคม',32).' พ.ศ. '.$this->StringToDot('2562',16).'
            </div>

            <div>
                <dd><dd>ถึงวันที่ '.$this->StringToDot('22',10).' เดือน '.$this->StringToDot('พฤษภาคม',32).' พ.ศ. '.$this->StringToDot('2562',16).'
            </div>

            <div>
                <dd><dd>รวมเวลา '.$this->StringToDot($this->CalHour($date_start[0],$date_end[0],9,16)+$S_hour_one+$S_hour_two,16).' ชั่วโมง โดยเสียค่าบริการเป็นเงิน '.$this->StringToDot($this->CalDay($this->CalHour($date_start[0],$date_end[0],9,16),$S_hour_one,$S_hour_two,$today)*700,20).'บาท
            </div>
