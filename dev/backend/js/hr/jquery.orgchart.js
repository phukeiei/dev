    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(typeof data.description !== 'undefined'){
                descString = '<p style="font-size: 12px;">'+self.data.description+'</p>';
            }
            if(opts.showControls){
                var buttonsHtml = "";
                // if(parseInt(self.data.level) != 0){
                    buttonsHtml +="<div class='org-del-button'>"+opts.delNodeText+"</div><div class='org-add-button'>"+opts.newNodeText+"</div>";
                // }else{
            ...
            var class_node = "node ";
            switch (parseInt(self.data.level)){
                case 0:
                    class_node += "org-level-1";
                    break;
                case 1:
                    class_node += "org-level-2";
                    break;
                case 2:
                    class_node += "org-level-3";
                    break;
                case 3:
                    class_node += "org-level-4";
                    break;
                default:
                    class_node += "org-level-5";
                    break;
            }
            
            str_ret = "<div class='"+class_node+"' node-id='"+this.data.id+"'>"+nameString+descString+buttonsHtml+"</div>";
