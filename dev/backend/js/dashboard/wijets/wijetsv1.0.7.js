			...
			$.each(json_obj,function(index,val){
				...
				html_txt +=			'</div>'+
					...
					if(val.chart_type == 'ch1' || val.chart_type == 'ch4'){
						...
						grp_data.push({'data' : {'series': val.chart_data, 'chart_type':val.chart_type, 'chart_cate':val.chart_cate, 'chart_table_link':val.chart_table_link, 'chart_x_name':chart_x_name}});
					}
				}
