 ...
 *
 v.1.0.8.1 new
 Replace Date:: 23 June 2017 : 09:15 AM
 Replacer:: JIrayus Arbking
 Comment:: New Style re_great add datepicker th style
 v.1.0.7
...
$.wijets = new function () {
    ...
    this.config_date_picker_re_great = {};
    ...
    var draw_card = function (data) {
        if (data != '') {
            ...
            var kpi_val = [];
            var kpi_key = [];
            //config re_great datepicker
            self.config_date_picker_re_great.format = 'dd-mm-yyyy';
            self.config_date_picker_re_great.language = 'th-th';
            self.config_date_picker_re_great.thaiyear = true;

            html_txt += '<div class="row sortable">';
            $.each(json_obj, function (index, val) {
                ...
                var txt_color = (typeof val.pn_hd_text_color == 'undefined') ? 'white' : val.pn_hd_text_color;
                if (val.widget_style == 'tile-card') {
                    ...
                    if (val.is_expand != 'false' && (typeof val.is_expand != 'undefined')) {
                        var i_frame = 0;
                        var header = '';
                        if (typeof val.is_expand.iframe != 'undefined') {
                            i_frame = 1;
                        }
                        if (typeof val.is_expand.header != 'undefined') {
                            header = val.is_expand.header;
                        }
                    ...
                    html_txt += '<div class="tile-icon" style="color: ' + val.tile_icocolor + ';"><i class="' + val.tile_icon + '" aria-hidden="true"></i></div>' +
                        ...
                        '<div class="tile-body"><span style="color:black;">' + val.tile_body + '</span></div>' +
                ...
                if (val.widget_style == 'tiles-card') {
                    if (data_qa != '') {
                        metric = qa_gen(data_qa);
                        html_txt += '<div class="sortable col-md-' + val.pn_size + ' metric-tooltips" data-toggle="tooltip" data-html="true" title="' + metric + '">';
                    } else {
                        html_txt += '<div class="sortable col-md-' + val.pn_size + '" >';
                    }
                    ...
                    $.each(val.tiles_tile, function (index_sub, tile) {
                        ...
                        if (tile.is_expand != 'false' && (typeof tile.is_expand != 'undefined')) {
                            var i_frame = 0;
                            var header = '';
                            if (typeof tile.is_expand.iframe != 'undefined') {
                                i_frame = 1;
                            }
                            if (typeof tile.is_expand.header != 'undefined') {
                                header = tile.is_expand.header;
                            }
                ...
                if (val.widget_style == 'chart-card') {
                    if (data_qa != '') {
                        metric = qa_gen(data_qa);
                        html_txt += '<div class="col-md-' + val.pn_size + ' panel-widget metric-tooltips" data-toggle="tooltip" data-html="true" title="' + metric + '">';
                    } else {
                        html_txt += '<div class="col-md-' + val.pn_size + ' panel-widget">';
                    }

                    html_txt += '<div class="panel">' +
                        '<div class="kart_adder" >' +
                        '<div class="btn-group">' +
                        '<a class="btn btn-default-alt cart_btn" href="#"><i class="fa fa-plus-circle fa-6 text-success " aria-hidden="true"></i></i></a>' +
                        '</div>' +
                        '</div>' +
                        '<div class="panel-heading" style="background-color:' + val.pn_hd_color + ';">' +
                        '<h2 style="color:' + txt_color + ';">' + val.pn_hd_text + '</h2>';
                    if (val.is_expand != 'false' && (typeof val.is_expand != 'undefined')) {
                        var i_frame = 0;
                        var header = '';
                        if (typeof val.is_expand.iframe != 'undefined') {
                    ...
                    html_txt += '</div>' +
                        '<div class="panel-body my-content no-padding"><br>' +
                    ...
                    if (val.chart_type == 'ch1' || val.chart_type == 'ch4') {
                        grp_data.push({
                            'data': {
                                'series': val.chart_data,
                                'chart_type': val.chart_type,
                                'show_legend': val.show_legend,
                                'xaxis_tile': val.xaxis_tile,
                                'chart_unit': val.chart_unit,
                                'tooltip': val.tooltip,
                                'align': val.align_legend,
                                'verticalAlign': val.verticalAlign_legend,
                                'layout': val.layout_legend,
                                'chart_name':val.pn_hd_text
                            }
                        });
                        ...
                        grp_data.push({
                            'data': {
                                'series': val.chart_data,
                                'chart_cate': val.chart_cate,
                                'show_legend': val.show_legend,
                                'xaxis_tile': val.xaxis_tile,
                                'chart_type': val.chart_type,
                                'chart_sub_type': val.chart_sub_type,
                                'chart_unit': val.chart_unit,
                                'chart_share': val.chart_share,
                                'tooltip': val.tooltip,
                                'chart_no_k': val.chart_no_k,
                                'align': val.align_legend,
                                'verticalAlign': val.verticalAlign_legend,
                                'layout': val.layout_legend,
                                'plotLines' : val.plot_lines,
                                'chart_name':val.pn_hd_text
                            }
                        }); //chart_no_k = not convert point
                    } else if (val.chart_type == 'ch3') { //line
                        grp_data.push({
                            'data': {
                                'series': val.chart_data,
                                'chart_cate': val.chart_cate,
                        ...
                        grp_data.push({
                            'data': {
                                ...
                                'chart_type': val.chart_type,
                                'chart_cate': val.chart_cate,
                                'chart_table_link': val.chart_table_link,
                                'chart_x_name': chart_x_name,
                                'chart_modal_iframe': chart_modal_iframe,
                                'chart_name':val.pn_hd_text
                            }
                        });
                    }
                ...
                if (val.widget_style == 'table-card') {
                    if (val.table_type == '1') {
                        ...
                        if (data_qa != '') {
                            metric = qa_gen(data_qa);
                            html_txt += '<div class="col-md-' + val.pn_size + ' metric-tooltips panel-widget" data-toggle="tooltip" data-html="true" title="' + metric + '">';
                        } else {
                            html_txt += '<div class="col-md-' + val.pn_size + ' panel-widget" >';
                        }
                        html_txt += '<div class="panel">' +
                        ...
                        if (!is_tableFade) {
                            ...
                            $.each(val.table_data.tb_row, function (tbody_temp, tbody_val) {
                                ...
                                if (tbody_val.is_expand.link != '' && (typeof tbody_val.is_expand != 'undefined')) {
                                    var i_frame = 0;
                                    var header = '';
                                    if (typeof tbody_val.is_expand.iframe != 'undefined') {
                                        i_frame = 1;
                                    }
                                    if (typeof tbody_val.is_expand.header != 'undefined') {
                                        header = tbody_val.is_expand.header;
                                    }
                            ...
                            $.each(val.table_data, function (tb_index, tb_val) {
                                ...
                                $.each(tb_val.tb_row, function (row_index, row_val) {
                                    ...
                                    if ((typeof row_val.is_expand != 'undefined')) {
                                        var i_frame = 0;
                                        var header = '';
                                        if (typeof row_val.is_expand.iframe != 'undefined') {
                                            i_frame = 1;
                                        }
                                        if (typeof row_val.is_expand.header != 'undefined') {
                                            header = row_val.is_expand.header;
                                        }
                    ...
                    if (val.table_type == '2') {
                        ...
                        if (val.table_detail == 'graduation') {
                            ...
                            html_txt += '<div class="panel">' +
                                '<div class="kart_adder" >' +
                                '<div class="btn-group">' +
                                '<a class="btn btn-default-alt" href="#"><i class="fa fa-plus-circle fa-6 text-success" aria-hidden="true"></i></i></a>' +
                                '</div>' +
                                '</div>' +
                                '<div class="panel-heading" style="background-color:' + val.pn_hd_color + ';">' +
                                '<h2 style="color:' + txt_color + ';">' + val.pn_hd_text + '</h2>' +
                    ...
                    if (val.table_type == 'special') {
                        ...
                        if (typeof val.table_data.tb_row_head[i].sub_th != 'undefined') {
                            ...
                            $.each(val.table_data.tb_row_head[i].sub_th, function (sub_th_temp, sub_th_val) {
                                if(typeof sub_th_val.data !== 'undefined'){
                                    // console.log(sub_th_val);
                                    var sub_attr = (typeof sub_th_val.attr === undefined) ? '' : sub_th_val.attr;
                                    var sub_data = (typeof sub_th_val.data === undefined) ? '' : sub_th_val.data ;
                                    html_txt += '<th ' + sub_attr + '>' + sub_data + '</th>';
                                }else{
                    ...
                    if (val.table_type == 'rs_sp1') {
                        ...
                        if (data_qa != '') {
                            ...
                            html_txt += '<div class="col-md-' + val.pn_size + ' metric-tooltips panel-widget" data-toggle="tooltip" data-html="true" title="' + metric + '"  id="dwnxx2">';
                        } else {
                            html_txt += '<div class="col-md-' + val.pn_size + ' panel-widget"  id="dwnxx2">';
                        }
                    ...
                    if (val.table_type == 'basic-npad') {
                        ...
                        html_txt += '' +
                            ...
                            '<div class="table-responsive"><table class="table table-hover table-striped table-bordered dataTable no-footer" id="table_number_' + index_the_great + '">' +
                            '<thead>' +
                            thr +
                            '</thead>' +
                            '<tbody>' +
                ...
                if (val.widget_style == 'special-card') {
                    var eqs_year_range = (typeof val.eqs_year_range != 'undefined') ? val.eqs_year_range : '2';

                    html_txt += '<div class="row">' +
                        '<div class="col-md-6">' +
                        '<div class="panel panel-danger">' +
                        '<div class="panel-heading" style="background-color:' + val.pn_hd_color + ';">' +
                        '<h2 style="color:' + txt_color + ';">จำนวนครุภัณฑ์ที่จะหมดอายุภายใน '+eqs_year_range+' ปี จำแนกตามประเภท</h2>' +
                        '</div>' +
                        '<div class="panel-body my-content">' +
                        '<div id="gpContainer' + index_the_great + '">gpContainer' + index_the_great + '</div>' +
                        '</div>' +
                        ...
                        '<div class="panel panel-danger">' +
                        '<div class="panel-heading" style="background-color:' + val.pn_hd_color + ';">' +
                        '<h2 style="color:' + txt_color + ';">รายการครุภัณฑ์ที่จะหมดอายุภายใน '+eqs_year_range+' ปี</h2>' +
                        '</div>' +
                        '<div class="panel-body my-content">' +
                    ...
                    grp_data.push({
                        'data': {
                            ...
                            'chart_type': val.chart_type,
                            'chart_cate': val.chart_cate,
                            'chart_dataTable': val.chart_dataTable
                        }
                    });
                }
                ...
                if (val.widget_style == 'great-card') {
                    ...
                    if (typeof val.re_great != 'undefined') {
                        ...
                        if (typeof val.re_great.type == 'undefined' || val.re_great.type != "datepicker") {
                            ...
                            $.each(val.re_great.details, function (ingret, vagret) {
                                ...
                                self.config_date_picker_re_great.format = vagret.format;
                                self.config_date_picker_re_great.startDate = vagret.startDate;
                                self.config_date_picker_re_great.endDate = vagret.endDate;
                                self.config_date_picker_re_great.setDate = vagret.setDate;

                                regret += '<input id="greater-card' + index_the_great + '"' +
                                    'class="re_the_great_datepicker form-control" ' +
                                    'data-date-language="th-th"  data-original-title="เลือกวันที่" ' +
                                    'style="text-align:center; display:inline-block;font-size:16px; height:39px;" ' +
                                    'value="' + vagret.setDate + '">';
                                regret += '</div>';
                            });
                        }
                    }
                    ...
                    if (data_qa != '') {
                        ...
                        html_txt += '<div class="col-md-' + val.pn_size + ' metric-tooltips  oh-the-great-card" data-toggle="tooltip" data-html="true" title="' + metric + '"  id="dwnxx2">';
                    } else {
                    ...
                    html_txt += '<div class="panel panel-danger">' +
                        ...
                        '<h2 style="color:' + txt_color + ';">' + val.pn_hd_text + '</h2>' + regret + expand + '';
                    html_txt += '</div>' +
                        ...
                        '</div>' +
                        '</div>';
                        // console.log($("#greater-card"+ index_the_great));
                ...
                if (val.widget_style == 'freestyle-card') {
                    html_txt += '<div class="col-md-' + val.pn_size + '">';
                    html_txt += '<div class="panel panel-danger">' +
                            '<div class="panel-body my-content the-great-card-panel" style="background:' + val.pn_color + ';">' +
                              val.html_in +
        ...
        onInit: function () {
            ...
            if (selectType) {
                ...
                $.post(is_switch(selectType), {path: selectType, param: selectParam, curId: flag})
                    ...
                    $(".table").css('visibility', 'visible');
                    $('.tooltips').tooltip({container: 'body'});
                    $(".re_the_great_datepicker").datepicker(self.config_date_picker_re_great).on('changeDate',function(e){

                        var parameter = '';
                        var parameter = $(this).val()+'_'+self.config_date_picker_re_great.startDate+'_'+self.config_date_picker_re_great.endDate;
    ...
    var makePlot = function (widget, param, payload) {
        ...
        //console.log(typeof payload.plotLines);
        var x_plotLines =null;
        var y_plotLines =null;
        if(typeof payload.plotLines !== 'undefined'){
            var x_plotLines = (typeof payload.plotLines.x !== 'undefined' ) ? payload.plotLines.x : null;
            var y_plotLines = (typeof payload.plotLines.y !== 'undefined' ) ? payload.plotLines.y : null;
        }
        
        //(x_plotLines!=null)?x_plotLines['width']=2:'';(y_plotLines!=null)?y_plotLines['width']=2:'';
        // console.log(y_plotLines);
        // console.log(widget.find('#' + param).width());
        ...
        if (payload.chart_type == 'ch1') {
            ...
            if(typeof payload.chart_cate.x1 == 'undefined'){
                var xxis = {
                ...
                var xxis = [{
                    categories: payload.chart_cate.x1,
                    labels: {
                        style: {
                            fontSize: size_of_font,
                        }
                    ...
                    categories: payload.chart_cate.x2,
                    labels: {
            ...
            if (widget.find('#' + param).length > 0) {
                var x = $(widget.find('#' + param)).highcharts({
                    chart: {
                        type: 'column',
                    },
                    credits: {
                        ...
                        column: {
                            ...
                            events: {
                                legendItemClick: function () {
                                    if(payload.chart_sub_type == 'stack_sp'){
                ...
                // console.log(x.highcharts().series);
            } //end param > 0
            ...
            if (widget.find('#' + param).length > 0) {
                console.log(payload.chart_name);
                Highcharts.getOptions().plotOptions.pie.colors = (function () {
                    var colors = [],
                        base = Highcharts.getOptions().colors[0],
                        i;
            ...
            $(widget.find('#' + param)).highcharts({
                ...
                plotOptions: {
                    column: {
                        ...
                        dataLabels: {
                            enabled: true,
                            format: '<span>{point.y:,.f}' + unit + '</span>',
                        }
                    }
                },
                series: [{
            ...
            var sub_type = 'pie';
            if(typeof payload.chart_sub_type !== 'undefined'){
                sub_type = payload.chart_sub_type;
            }
            /*else{
            ...
            if (widget.find('#' + param).length > 0) {
                ...
                $.each(payload.series, function (index, val) {
                    ...
                    if (typeof val.child != 'undefined' && val.child != '' && typeof val.id != 'undefined' && typeof val.id != '') {
                        ...
                        $.each(val.child, function (cdex, cval) {console.log(cval);
                            if(typeof cval.name !== 'undefined'){
                                data_sub_sub.push({
                                name: cval.name,
                                y: cval.y,
                                color: cval.color,
            ...
            if (widget.find('#' + param).length > 0) {
                ...
                $(widget).closest('.panel-body.my-content').append(html_sp);
                //index_the_great++;
                $(widget.find('#' + param)).highcharts({
                    chart: {
                        renderTo: 'container1',
                                    ...
                                    click: function () {
                                        if (payload.chart_table_link != '') {
                                            ...
                                            $.post(is_switch(path), {
                                                ...
                                                .done(function (data) {
                                                    $.when(draw_card(data)).done(function (arg1) {
                                                        var widget_area = $(widget).closest('.panel-body.my-content');
                                                        widget.find('.panel-loading').remove();
                                ...
                                events: {
                                    click: function () {
                                        if (payload.chart_table_link != '') {
                                            ...
                                            $('#myModal').find('.panel-loading').fadeOut(300, function () {
                                                $(this).remove();
                                            });
                                            $('#myModal').modal();
                                            event.preventDefault();
        ...
        // console.log(widget.find('#'+param).html());
    }
    // helpers
    ...
    $("body").on("click", '#saveButton', function () {
        ...
        //console.log(arr);
        $.post(the_path + '/index.php/dashboard/Data_management/save_config2', {
            param1: JSON.stringify(arr),
            grp_name: page_id
    ...
    var load_local = function () {
        ...
        $.post(the_path + '/index.php/dashboard/Data_management/load_config2', {
            type: 'r',
            grp_name: page_id
        }, function (data, textStatus, xhr) {
    ...
    this.Mymake = function (settings) {
        ...
        $("body").on("click", '.expand-button-new,.expand-panel,.complex_ele', function (event) {
            ...
            if ($(this).attr('i_frame') != 1) {
                $.post(file_name, {param: parameter}, function (data) {
                    $('#myModal').find('.modal-title').html(temp);
                    $('#myModal').find('.modal-body').html(data);
                    $('#myModal').find('.modal-footer').html('<button type="button" class="btn btn-midnightblue-alt" data-dismiss="modal">Close</button>');

                });
            } else {
                var H = window.innerHeight * 0.77;
                ...
                $('#myModal').find('.modal-footer').html('<button type="button" class="btn btn-midnightblue-alt" data-dismiss="modal">Close</button><button style="float:left" type="button" class="btn btn-midnightblue-alt frame_back" id="frame_back_once">กลับ</button><button style="float:left" type="button" class="btn btn-midnightblue-alt frame_back" id="frame_back">กลับหน้าแรก</button>');
            }
            $('#myModal').find('.panel-loading').fadeOut(300, function () {
                $(this).remove();
            });
        ...
        $("body").on("click", '#frame_back_once', function () {
            var ptr = $(this).closest('.modal-dialog').find('iframe')[0];
            console.log(ptr);
            ptr.history.back();
        });
                ...
                if (params.length > 0) {
                    ...
                    if (params && params.id) {
                        ...
                        if (localStorage.getItem(widgetId + '.selectType') != undefined) { //check old parameter
                            ...
                            widget.append('<div class="panel-loading" st><div class="panel-loader-circular"></div></div>');
                            try {
                                $.post(is_switch(selectType), {path: selectType, param: selectParam, curId: flag})
                                    .done(function (data) {
                                        var index_arg = 0;
