	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sEmptyTable": "** ไม่ปรากฏรายการในฐานข้อมูล **",
				"sLoadingRecords": "กำลังโหลด...",
				"sInfo": "แสดงรายการที่ _START_ ถึง _END_ จาก _TOTAL_ รายการ",
				"sInfoEmpty": "",
				"sInfoFiltered": "(จากข้อมูลที่มีทั้งหมด _MAX_ รายการ)",
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "ค้นหา:",
				"sUrl": "",
		...
		function _fnDraw( oSettings )
		{
			...
			else
			{
				...
				nTd.style.cssText = 'text-align:center;color:red;';	//-- ADD BY meuzicxx 20130905
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" style="width:80%;height:30px;" placeholder="พิมพ์คำที่ต้องการค้นหา" />') :
			  sSearchStr==="" ? '<input type="text" style="width:80%;height:30px;" placeholder="พิมพ์คำที่ต้องการค้นหา" />' : sSearchStr+' <input type="text" style="width:80%;height:30px;" placeholder="พิมพ์คำที่ต้องการค้นหา" />';
			
			var nFilter = document.createElement( 'div' );
			nFilter.style.cssText = 'width:30%;';	//-- ADD BY meuzicxx 20130905
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<label style="width:100%;">'+sSearchStr+'</label>';
		...
		function _fnFeatureHtmlProcessing ( oSettings )
		{
			...
			if ( oSettings.sTableId !== '' && typeof oSettings.aanFeatures.r == "undefined" )
			{
				...
				nProcessing.style.cssText = 'padding-left:10px;color:orange;';	//-- ADD BY meuzicxx 20130905
			}
