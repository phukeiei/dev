...
(function($) {
	$(document).ready(function(e) {
		...
		$("#da-ex-timepicker1").timepicker({});
		$("#da-ex-timepicker2").timepicker({});
		$("#da-ex-timepicker3").timepicker({});
		$("#da-ex-timepicker4").timepicker({});
		$("#da-ex-timepicker5").timepicker({});
		$("#da-ex-timepicker6").timepicker({});
		$("#da-ex-timepicker7").timepicker({});
		$("#da-ex-timepicker8").timepicker({});
		...
		if($.jGrowl) {
			$("#da-ex-growl").bind("click", function(event) {
				$.jGrowl("บันทึกข้อมูลเรียบร้อยแล้ว", {position: "bottom-right"});
			});
