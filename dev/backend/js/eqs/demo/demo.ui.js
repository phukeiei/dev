...
(function($) {
	$(document).ready(function(e) {
		...
		$("#da-ex-accordion, #da-ex-accordion-plain").accordion({collapsible: true});
		...
		$("#da-ex-dialog-modal1").bind("click", function(event) {
			$("#da-ex-dialog-div1").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal2").bind("click", function(event) {
			$("#da-ex-dialog-div2").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal3").bind("click", function(event) {
			$("#da-ex-dialog-div3").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal4").bind("click", function(event) {
			$("#da-ex-dialog-div4").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal5").bind("click", function(event) {
			$("#da-ex-dialog-div5").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal6").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal7").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal8").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal9").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal10").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal11").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal12").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal13").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal14").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
		$("#da-ex-dialog-modal15").bind("click", function(event) {
			$("#da-ex-dialog-div6").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
