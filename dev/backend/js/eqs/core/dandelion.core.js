...
(function($) {
	$(document).ready(function(e) {
		...
		/* Collapsible Panels */
		$("div.da-panel.collapsible .da-panel-header").live("click", function(e) {
			parentToggled = false;
		...
		/* Dropdown Navigation */
		$("div#da-header #da-header-bottom #da-search  #da-main-nav ul li a, div#da-header #da-header-bottom #da-search  #da-main-nav ul li span").bind("click", function(e) {
