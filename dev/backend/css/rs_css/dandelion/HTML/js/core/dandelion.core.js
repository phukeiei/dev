...
(function($) {
	$(document).ready(function(e) {
		...
		/* Panel Toggler */
		$(".da-panel.collapsible_fshow .da-panel-header").each(function() {
		...
		/* Collapsible Panels */
		$("div.da-panel.collapsible_fshow .da-panel-header .da-panel-toggler").live("click", function(e) {
			parentToggled = false;
		...
		$(".da-panel.collapsible_fhide .da-panel-header").each(function() {
			if($(this).find('.da-panel-toggler').size() === 0) {
				$('<span></span>').addClass("da-panel-toggler").appendTo($(this));
			}
			parentToggled = false;
		...
		/* Collapsible Panels */
		$("div.da-panel.collapsible_fhide .da-panel-header .da-panel-toggler").live("click", function(e) {
			parentToggled = false;
			$(this).closest(".da-panel").children(":not(.da-panel-header)").slideToggle("normal", function() {
				if(!parentToggled) {
					$(this).closest(".da-panel").toggleClass("collapsed");
